...
final class Logging
{
    ...
    public function updateAsyncRecord(
        ...
        DB::transaction(function () use ($requestId, $output, $decodedPayload): void {
            ...
            DB::table('request_raw')->insert([
                'request_id' => $requestId,
                'request_payload' => PayloadMasker::mask(json_encode($decodedPayload, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE)),
                'response_payload' => $output->parsedResponse !== null
                    ? PayloadMasker::mask(json_encode($output->parsedResponse, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE))
                    : null,
